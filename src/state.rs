...
impl State {
    ...
    pub fn get_last_reading_state(&self, ebook: &crate::ebook::Ebook) -> Result<ReadingState> {
    ...
    pub fn set_last_reading_state(&self, ebook: &crate::ebook::Ebook, reading_state: &ReadingState) -> Result<()> {
        self.conn.execute(
    ...
    pub fn insert_bookmark(&self, ebook: &crate::ebook::Ebook, name: &str, reading_state: &ReadingState) -> Result<()> {
    ...
    pub fn delete_bookmark(&self, ebook: &crate::ebook::Ebook, name: &str) -> Result<()> {
        self.conn.execute(
    ...
    pub fn get_bookmarks(&self, ebook: &crate::ebook::Ebook) -> Result<Vec<(String, ReadingState)>> {
    ...
    pub fn update_library(&self, ebook: &crate::ebook::Ebook, reading_progress: Option<f32>) -> Result<()> {
